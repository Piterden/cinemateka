...
@section('content')
    <div class="error-page">
        <h2 class="headline text-yellow text-center" style="font-size: 180px; float: none;"> 429</h2>

        <div class="text-center m-l-0">
          <h3 class="m-t-0"><i class="fa fa-warning text-yellow"></i> Too many requests.</h3>
